  ...
  <div class="container">
    ...
    <div class="nav-page">
      <el-breadcrumb separator="/">
        <el-breadcrumb-item :to="{ path: '/index/pagehostlist' }" :replace="true">VPS列表</el-breadcrumb-item>
        <el-breadcrumb-item>增加VPS</el-breadcrumb-item>
      </el-breadcrumb>
    </div>
        ...
        <div style="margin-right: 20px;margin-top: 5px">
          <el-form label-width="120px">
            <el-form-item label="主机IP：">
              <el-input v-model="hostip"></el-input>
            </el-form-item>
            <el-form-item label="FM类型：">
              <el-select v-model="fmtype" placeholder="请选择" style="display: inline-block;width: 100%">
                <el-option
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      submitData(){
        if (utils.isEmpty(this.hostip)) {
          this.$message("主机IP未填写!");
          return;
        }
        if (utils.isEmpty(this.fmtype)) {
          this.$message("FM类型未选择!");
          return;
        }
        this.addNewPdData();
      },
