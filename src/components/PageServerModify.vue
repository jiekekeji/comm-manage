  ...
  export default {
    ...
    methods: {
      initData(){
        ...
        this.signalok = commodity.signalok;
        this.accountok = commodity.accountok;
        this.serverid = commodity.serverid;
        this.btnTx = "确认修改";
      },
      closePage(){
        this.$router.go(-1);
      ...
      updatePdData(){
        ...
        var _this = this
        var paras = {
          action: "sys_server_modify",
          userid: userid,
          random: random,
          randomkey: randomkey,
          serverid: _this.serverid,
          signalok: _this.signalok,
          accountok: _this.accountok,
        }
        $.ajax({
          traditional: true,
          url: api.APPURL,
